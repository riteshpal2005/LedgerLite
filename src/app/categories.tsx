...
export default function CategoriesScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background" edges={['top']}>
      <View className="px-6 py-4 flex-row items-center border-b border-bordercolor/50">
      ...
      <Pressable
        ...
        className="absolute bottom-10 right-6 w-16 h-16 bg-blue-600 rounded-full items-center justify-center shadow-lg elevation-5"
      >
