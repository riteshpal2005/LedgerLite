...
export default function BackdatedScreen() {
  ...
  return (
    <View className="flex-1 bg-emerald-bg-dark pt-12">
      <View className="flex-row items-center justify-between px-6 mb-6 mt-2">
        ...
        <View className="items-center">
          ...
          <View className="bg-emerald-500/15 px-3 py-1 rounded-full flex-row items-center">
            <Ionicons name="time" size={12} color="#10b981" className="mr-1.5" />
            <Text className="text-emerald-500 text-2xs font-bold uppercase tracking-wider">
              Time Travel Mode Active
            </Text>
          </View>
        </View>
        <Pressable className="w-10 items-end">
          <View className="w-6 h-6 rounded-full border-2 border-emerald-500 items-center justify-center">
      ...
      <View className="px-6 mb-6">
        {}
        <View className="flex-row items-center bg-emerald-bg-dark rounded-xl px-4 h-[46px] border border-emerald-border-dark mb-4">
          <Ionicons name="search" size={20} color="#71717a" />
          <Text className="flex-1 text-zinc-500 text-15px ml-3">Search transactions...</Text>
        ...
        <View className="flex-row items-center">
          <View className="flex-1 mr-3">
            <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row">
              <View className="flex-row items-center bg-emerald-bg-dark border border-emerald-border-dark rounded-lg px-3 py-2 mr-3">
              ...
              <View className="flex-row items-center bg-emerald-bg-dark border border-emerald-border-dark rounded-lg px-3 py-2">
          ...
          <View className="h-[38px] w-[38px] items-center justify-center bg-emerald-bg-dark border border-emerald-500/30 rounded-lg">
      ...
      <View className="px-6 mb-6">
        <View className="bg-emerald-surface-dark border border-emerald-border-dark rounded-xl flex-row items-center py-4 px-2">
          <View className="flex-1 items-center justify-center border-r border-emerald-border-dark">
            <Text className="text-gray-400 text-xs mb-1">Total Income</Text>
            <Text className="text-emerald-500 font-bold text-15px">{formatCurrency(28450)}</Text>
          </View>
          <View className="flex-1 items-center justify-center border-r border-emerald-border-dark">
            <Text className="text-gray-400 text-xs mb-1">Total Expenses</Text>
            <Text className="text-red-500 font-bold text-15px">{formatCurrency(-21890)}</Text>
          </View>
          <View className="flex-1 items-center justify-center">
            <Text className="text-gray-400 text-xs mb-1">Net Balance</Text>
            <Text className="text-emerald-500 font-bold text-15px">{formatCurrency(6560)}</Text>
          </View>
        </View>
      </View>
      ...
      <View className="px-6 flex-row items-center justify-between mb-4">
        ...
        <View className="flex-row items-center bg-emerald-bg-dark border border-emerald-border-dark rounded-lg px-2 py-1">
      ...
      <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row items-center justify-between mb-2">
          <View className="flex-row items-center">
            ...
            <Text className="text-gray-300 text-sm">Fri, 13 Jun 2025</Text>
          </View>
          <Text className="text-emerald-500 text-sm font-bold">+{formatCurrency(5000)}</Text>
        </View>

        <View className="bg-emerald-surface-dark border border-emerald-border-dark rounded-xl p-3 flex-row items-center mb-6">
          ...
          <View className="flex-1">
            ...
            <Text className="text-emerald-500 text-xs">Income</Text>
            <View className="flex-row items-center mt-1">
              <Ionicons name="business" size={12} color="#9ca3af" className="mr-1" />
              <Text className="text-gray-400 text-xs">SBI Bank Account</Text>
            </View>
          </View>
          <View className="items-end relative">
            <Text className="text-emerald-500 font-bold text-15px mb-1 mr-5">{formatCurrency(5000)}</Text>
        ...
        <View className="flex-row items-center justify-between mb-2">
          <View className="flex-row items-center">
            ...
            <Text className="text-gray-300 text-sm">Thu, 12 Jun 2025</Text>
          </View>
          <Text className="text-red-500 text-sm font-bold">{formatCurrency(-1250)}</Text>
        </View>
        ...
        <View className="bg-emerald-surface-dark border border-emerald-border-dark rounded-xl p-3 flex-row items-center mb-6">
          ...
          <View className="flex-1">
            ...
            <View className="flex-row items-center mt-1">
              ...
              <Text className="text-gray-400 text-xs">Cash Wallet</Text>
            </View>
          </View>
          <View className="items-end relative">
            <Text className="text-red-500 font-bold text-15px mb-1 mr-5">{formatCurrency(-1250)}</Text>
        ...
        <View className="flex-row items-center justify-between mb-2">
          <View className="flex-row items-center">
            <Ionicons name="calendar-outline" size={14} color="#9ca3af" className="mr-2" />
            <Text className="text-gray-300 text-sm">Wed, 11 Jun 2025</Text>
          </View>
          <Text className="text-red-500 text-sm font-bold">{formatCurrency(-1890)}</Text>
        </View>
        ...
        <View className="bg-emerald-surface-dark border border-emerald-border-dark rounded-xl p-3 flex-row items-center mb-6">
          ...
          <View className="items-end relative">
            <Text className="text-red-500 font-bold text-15px mb-1 mr-5">{formatCurrency(-1890)}</Text>
        ...
        <View className="flex-row items-center justify-between mb-2">
          <View className="flex-row items-center">
            <Ionicons name="calendar-outline" size={14} color="#10b981" className="mr-2" />
            <Text className="text-gray-300 text-sm">Tue, 10 Jun 2025</Text>
          </View>
          <Text className="text-emerald-500 text-sm font-bold">+{formatCurrency(2500)}</Text>
        </View>
        ...
        <View className="bg-emerald-surface-dark border border-emerald-border-dark rounded-xl p-3 flex-row items-center mb-6">
          ...
          <View className="items-end relative">
            <Text className="text-emerald-500 font-bold text-15px mb-1 mr-5">{formatCurrency(2500)}</Text>
            <Text className="text-gray-400 text-xs mr-5">11:10 AM</Text>
            <Ionicons name="chevron-forward" size={16} color="#4b5563" className="absolute right-0 top-3" />
          </View>
        </View>

        <Text className="text-center text-gray-400 text-sm mt-4 mb-24">No more transactions</Text>
      </ScrollView>

      <Pressable
        onPress={handlePresentModalPress}
        className="absolute bottom-6 right-6 w-[60px] h-[60px] bg-emerald-500 rounded-full items-center justify-center shadow-lg">
