      ...
      <View className="bg-surface rounded-2xl p-4 border border-bordercolor">
        ...
        >
          <View className="flex-1 pr-4">
            <Text className="text-primary text-lg font-semibold mb-1">Backdated Data Entry</Text>
            <Text className="text-tertiary text-xs leading-5">
              Log historical expenses safely. This mode adjusts your Initial Balance automatically to preserve your true Current Balance today.
            </Text>
          </View>
