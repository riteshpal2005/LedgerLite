...
export function BulkAccountMappingModal({
  visible,
  missingAccounts,
  onClose,
  onConfirm,
            ...
            >
              <View className="px-6 pt-6 pb-2">
                ...
                <Text className="text-secondary mb-4">
                  We found {missingAccounts.length} account
                  {missingAccounts.length > 1 ? "s" : ""} in your import file
                  that don't exist in LedgerLite. Please configure them below to
                  proceed.
                </Text>
              </View>
