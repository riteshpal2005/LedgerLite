    ...
    <>
      <View className="flex-row gap-4 mb-4">
        <View className="flex-1 bg-surface rounded-2xl p-4 border border-bordercolor">
          ...
          <Pressable onPress={() => setShowDatePicker(true)} className="flex-row items-center justify-between border-b border-bordercolor pb-1">
            <Text className="text-primary text-lg font-semibold flex-1 mr-2">{dateStr}</Text>
        ...
        <View className="flex-1 bg-surface rounded-2xl p-4 border border-bordercolor">
          ...
          <Pressable onPress={() => setShowTimePicker(true)} className="flex-row items-center justify-between border-b border-bordercolor pb-1">
            <Text className="text-primary text-lg font-semibold flex-1 mr-2">{timeStr}</Text>
