          ...
          {mode === 'date' ? (
            <View>
              ...
              <View className="flex-row justify-between items-center mb-6">
                <Pressable onPress={handlePrevMonth} className="p-2 bg-white/5 rounded-full">
                  <Ionicons name="chevron-back" size={24} color="#f4f4f5" />
                </Pressable>
                <Text className="text-primary text-xl font-bold">
                  {monthNames[currentMonth.getMonth()]} {currentMonth.getFullYear()}
                </Text>
                <Pressable onPress={handleNextMonth} className="p-2 bg-white/5 rounded-full">
            ...
            <View>
              ...
              <View className="flex-row justify-center items-center gap-4 mb-10">
                ...
                <View className="items-center">
                  <Pressable onPress={() => adjustHour(1)} className="p-3 bg-white/5 rounded-xl mb-3">
                  ...
                  <Pressable onPress={() => adjustHour(-1)} className="p-3 bg-white/5 rounded-xl mt-3">
                ...
                {/* Minute */}
                <View className="items-center">
                  <Pressable onPress={() => adjustMinute(1)} className="p-3 bg-white/5 rounded-xl mb-3">
                    <Ionicons name="chevron-up" size={28} color="#3b82f6" />
                  </Pressable>
                  <View className="bg-background w-24 h-20 justify-center items-center rounded-2xl border border-bordercolor">
                    <TextInput 
                  ...
                  <Pressable onPress={() => adjustMinute(-1)} className="p-3 bg-white/5 rounded-xl mt-3">
                    <Ionicons name="chevron-down" size={28} color="#3b82f6" />
                  </Pressable>
                </View>
